...
import 'package:loyalty_app/src/locations.dart' as locations;
...
class _BodyState extends State<Body> {
  ...
  Widget listStore(locations.Locations storeLocations) {
